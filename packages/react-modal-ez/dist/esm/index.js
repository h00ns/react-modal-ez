...
var useScrollLock = function (enable) {
    var _a = useState(""), prevOverflowY = _a[0], setPrevOverflowY = _a[1];
    useEffect(function () {
...
function Controller(_a) {
    ...
    if (dimmed) {
        return (jsx("div", { className: "".concat(css.dimmed, " ").concat(dimmedClassName), children: jsx(ModalWrap, {}) }));
    }
    return jsx(ModalWrap, {});
    function ModalWrap() {
        return (jsx("div", { ref: modalRef, className: "".concat(css.modal, " ").concat(positionCss, " ").concat(modalClassName), style: style, children: children }));
    }
}
...
function ModalProvider(_a) {
    ...
    return (jsxs(ModalContext.Provider, { value: { isOpen: isOpen, modal: modal, handleOpen: handleOpen, handleClose: handleClose, setModal: setModal }, children: [children, isOpen && modal && (jsx(Controller, __assign({ handleClose: handleClose }, modal.options, { children: modal.element })))] }));
}
